...
const AddMaterial = ({ onCancel, onSubmit, existingCategories = [] }) => {
    ...
    // Combine defaults with existing (dynamic) categories
    const defaultCategories = ['Wood', 'Metal', 'Ceramic', 'Concrete', 'Glass', 'Electrical'];
    const uniqueCategories = Array.from(new Set([...defaultCategories, ...existingCategories])).filter(c => c !== 'Others' && c !== 'All');
    const categories = [...uniqueCategories.sort(), 'Others']; // Ensure Others is last
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex flex-col items-center justify-center p-4 rounded-xl border transition-all ${formData.availability === opt.id
